...
var MemStorage = /** @class */ (function () {
    ...
    MemStorage.prototype.saveChatMessage = function (insertMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var id, message;
            return __generator(this, function (_a) {
                id = randomUUID();
                message = __assign(__assign({}, insertMessage), { id: id, timestamp: new Date(), metadata: insertMessage.metadata || null });
                this.chatMessages.set(id, message);
                return [2 /*return*/, message];
            });
        });
    };
    MemStorage.prototype.getChatHistory = function (sessionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.chatMessages.values())
                        .filter(function (msg) { return msg.sessionId === sessionId; })
